...
<li>Vendor - A legal entity that has been awarded a Project</li>
...
<li>Activity - The Activity collection provides objects representing the ongoing activity of one or more of the other entity types. It is a time series of the world of government procurement.</li>
</ul>
<h1 id="entities">Entities</h1>
</div></div><div><div class="panel panel-default"><div class="panel-heading"><h3 id="">Resource Group&nbsp;<a href="#"><i class="fa fa-link"></i></a></h3></div><div class="panel-body"><h4 id="-entity-collection">Entity Collection&nbsp;<a href="#-entity-collection"><i class="fa fa-link"></i></a></h4><p>Collection of one of the eight types of entities, returned as a paginated list of NTIs (name, type, ID), ordered by timestamp.</p>
<section id="-entity-collection-get" class="panel panel-info"><div class="panel-heading"><div style="float:right"><span style="text-transform: lowercase">List Entities</span></div><div style="float:left"><a href="#-entity-collection-get" class="btn btn-xs btn-primary">GET</a></div><div style="overflow:hidden"><code>/{entityType}/{?skip,take}</code></div></div><ul class="list-group"><li class="list-group-item bg-default"><strong>Parameters</strong></li><li class="list-group-item"><dl class="dl-horizontal"><dt>entityType</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>project</span></span><p>The type of entities to be returned</p>
...
</dd></dl></li></ul><ul class="list-group"><li class="list-group-item"><strong>Request&nbsp;&nbsp;<code>Entities</code></strong><a data-toggle="collapse" data-target="#45f58e344668d803cc367d16deaefd12" class="pull-right">Toggle</a></li><li id="45f58e344668d803cc367d16deaefd12" class="list-group-item panel-collapse collapse"><div class="description"></div><h5>Headers</h5><pre><code><span class="hljs-attribute">Accept</span>: <span class="hljs-string">application/json</span><br><span class="hljs-attribute">X-GT-API-Key</span>: <span class="hljs-string">yourAPIKey</span><br></code></pre></li><li class="list-group-item"><strong>Response&nbsp;&nbsp;<code>200</code></strong><a data-toggle="collapse" data-target="#d03d76958064a15da5c8f4b62d2423b3" class="pull-right">Toggle</a></li><li id="d03d76958064a15da5c8f4b62d2423b3" class="list-group-item panel-collapse collapse"><h5>Body</h5><pre><code>{
...
</dd></dl></li></ul><ul class="list-group"><li class="list-group-item"><strong>Request&nbsp;&nbsp;<code>Search Projects</code></strong><a data-toggle="collapse" data-target="#5c7a9222805e596100af655acc6d42a3" class="pull-right">Toggle</a></li><li id="5c7a9222805e596100af655acc6d42a3" class="list-group-item panel-collapse collapse"><div class="description"></div><h5>Headers</h5><pre><code><span class="hljs-attribute">Accept</span>: <span class="hljs-string">application/json</span><br><span class="hljs-attribute">X-GT-API-Key</span>: <span class="hljs-string">yourAPIKey</span><br></code></pre></li><li class="list-group-item"><strong>Response&nbsp;&nbsp;<code>200</code></strong><a data-toggle="collapse" data-target="#794a0efc7b4661f9a82909cfd4bcf084" class="pull-right">Toggle</a></li><li id="794a0efc7b4661f9a82909cfd4bcf084" class="list-group-item panel-collapse collapse"><h5>Body</h5><pre><code>{
    "<span class="hljs-attribute">Hello</span>" : <span class="hljs-value"><span class="hljs-string">"You Fool"</span>
</span>}
</code></pre><h5>Schema</h5><pre><code>{
    "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
...
</dd></dl></li></ul><ul class="list-group"><li class="list-group-item"><strong>Request&nbsp;&nbsp;<code>Search Projects</code></strong><a data-toggle="collapse" data-target="#aec67a9715a38355e44303d09594cba4" class="pull-right">Toggle</a></li><li id="aec67a9715a38355e44303d09594cba4" class="list-group-item panel-collapse collapse"><div class="description"></div><h5>Headers</h5><pre><code><span class="hljs-attribute">Accept</span>: <span class="hljs-string">application/json</span><br><span class="hljs-attribute">X-GT-API-Key</span>: <span class="hljs-string">yourAPIKey</span><br></code></pre></li><li class="list-group-item"><strong>Response&nbsp;&nbsp;<code>200</code></strong><a data-toggle="collapse" data-target="#d48255d7a8e840791d75484dfdc186f0" class="pull-right">Toggle</a></li><li id="d48255d7a8e840791d75484dfdc186f0" class="list-group-item panel-collapse collapse"><h5>Body</h5><pre><code>{
    "<span class="hljs-attribute">Hello</span>" : <span class="hljs-value"><span class="hljs-string">"You Fool"</span>
</span>}
</code></pre><h5>Schema</h5><pre><code>{
    "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
...
</dd></dl></li></ul><ul class="list-group"><li class="list-group-item"><strong>Request&nbsp;&nbsp;<code>Search Vendors</code></strong><a data-toggle="collapse" data-target="#35d3519ee3111087c3deb983a508a8ac" class="pull-right">Toggle</a></li><li id="35d3519ee3111087c3deb983a508a8ac" class="list-group-item panel-collapse collapse"><div class="description"></div><h5>Headers</h5><pre><code><span class="hljs-attribute">Accept</span>: <span class="hljs-string">application/json</span><br><span class="hljs-attribute">X-GT-API-Key</span>: <span class="hljs-string">yourAPIKey</span><br></code></pre></li><li class="list-group-item"><strong>Response&nbsp;&nbsp;<code>200</code></strong><a data-toggle="collapse" data-target="#5182b009ead06aace72fe298736a4d6d" class="pull-right">Toggle</a></li><li id="5182b009ead06aace72fe298736a4d6d" class="list-group-item panel-collapse collapse"><h5>Body</h5><pre><code>{
    "<span class="hljs-attribute">Hello</span>" : <span class="hljs-value"><span class="hljs-string">"You Fool"</span>
</span>}
</code></pre><h5>Schema</h5><pre><code>{
    "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
...
</dd></dl></li></ul><ul class="list-group"><li class="list-group-item"><strong>Request&nbsp;&nbsp;<code>Activity</code></strong><a data-toggle="collapse" data-target="#4434d12d1bac99f550ad1982ffce7307" class="pull-right">Toggle</a></li><li id="4434d12d1bac99f550ad1982ffce7307" class="list-group-item panel-collapse collapse"><div class="description"></div><h5>Headers</h5><pre><code><span class="hljs-attribute">Accept</span>: <span class="hljs-string">application/json</span><br><span class="hljs-attribute">X-GT-API-Key</span>: <span class="hljs-string">yourAPIKey</span><br></code></pre></li><li class="list-group-item"><strong>Response&nbsp;&nbsp;<code>200</code></strong><a data-toggle="collapse" data-target="#98e2647a7450bbba9a9d3da3a402ee63" class="pull-right">Toggle</a></li><li id="98e2647a7450bbba9a9d3da3a402ee63" class="list-group-item panel-collapse collapse"><h5>Body</h5><pre><code>{
    "<span class="hljs-attribute">Hello</span>" : <span class="hljs-value"><span class="hljs-string">"there"</span></span>,
    "<span class="hljs-attribute">You look</span>" : <span class="hljs-value"><span class="hljs-string">"nice"</span>
</span>}
</code></pre><h5>Schema</h5><pre><code>{
...
</code></pre></li></ul></section><h4 id="activity-activity-feed">Activity Feed&nbsp;<a href="#activity-activity-feed"><i class="fa fa-link"></i></a></h4><p>Retrieving multiple activity objects for one or more entities produces an activity feed. This is accomplished by submitting an array of <code>_id</code> properties to the <code>feed</code> endpoint along with a timestampRange. </p>
...
<p>For example, let’s say you are interested in seeing the contracting activity for 3 different person entities. For this exampe, you will submit the three <code>_id</code> strings (in an array) to the <code>feed</code> endpoint.</p>
            ...
            "<span class="hljs-attribute">items</span>" : <span class="hljs-value">{
                ...
                "<span class="hljs-attribute">properties</span>" : <span class="hljs-value">{
                    ...
                    "<span class="hljs-attribute">participants</span>" : <span class="hljs-value">{
                        ...
                        "<span class="hljs-attribute">items</span>": <span class="hljs-value">{
                            "<span class="hljs-attribute">type</span>" : <span class="hljs-value"><span class="hljs-string">"string"</span></span>,
                            "<span class="hljs-attribute">description</span>" : <span class="hljs-value"><span class="hljs-string">"An id for an entity involved in this activity message"</span>
                        </span>}
                    </span>}</span>,    
                    "<span class="hljs-attribute">targets</span>" : <span class="hljs-value">{
                        "<span class="hljs-attribute">type</span>" : <span class="hljs-value"><span class="hljs-string">"array"</span></span>,
