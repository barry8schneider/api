...
<p>Interested in everything else Army Corps of Engineers does? Load its activity:
```json
GET <a href="http://api.govtribe.com/activity/feed?ids=51c1d4f8db40a5298c79c77f">http://api.govtribe.com/activity/feed?ids=51c1d4f8db40a5298c79c77f</a></p>
...
<p>The GovTribe API is currently in beta. As such, it’s subject to change and all API data and services are provided as is. We reserve the right to make changes to the API during beta without notification. Have an issue or feature request? Log it on our <a href="https://github.com/GovTribe/api">GitHub repo</a>.  </p>
<h1 id="group-collection">Group Collection</h1>
<h2 id="entity-collection-entitytype-">Entity Collection [/{entityType}/]</h2>
<p>Collection of one of the eight types of entities, returned as a paginated list of NTIs (name, type, ID), ordered by timestamp.</p>
<ul>
<li><p>Parameters</p>
<ul>
<li>entityType (required, string <code>project</code>) … The type of entities to be returned<ul>
<li>Values<ul>
...
<ul>
<li><p>Headers</p>
<pre><code>  Content<span class="hljs-attribute">-Type</span>: application/json
  X<span class="hljs-attribute">-GT</span><span class="hljs-attribute">-Rate</span><span class="hljs-attribute">-Limit</span>: <span class="hljs-number">1000</span>
  X<span class="hljs-attribute">-GT</span><span class="hljs-attribute">-Rate</span><span class="hljs-attribute">-Limit</span><span class="hljs-attribute">-Remaining</span>: <span class="hljs-number">999</span>
  X<span class="hljs-attribute">-GT</span><span class="hljs-attribute">-API</span><span class="hljs-attribute">-Version</span>: <span class="hljs-number">3.0</span>
  X<span class="hljs-attribute">-GT</span><span class="hljs-attribute">-Response</span><span class="hljs-attribute">-Time</span>: <span class="hljs-number">0.181</span> sec
</code></pre></li>
<li><p>Body</p>
...
</code></pre><h3 id="list-entities-get-">List Entities [GET]</h3>
<ul>
<li><p>Request Entities</p>
<ul>
<li><p>Headers</p>
<pre><code>  <span class="hljs-attribute">Accept</span>: <span class="hljs-string">application/json</span>
  <span class="hljs-attribute">X-GT-API-Key</span>: <span class="hljs-string">yourAPIKey</span>
</code></pre></li>
</ul>
</li>
<li><p>Response 200</p>
<p>  [Entity Collection][]</p>
</li>
</ul>
<h1 id="group-project">Group Project</h1>
<h2 id="project-project-_id-">Project [/project/{_id}]</h2>
<p>A project is a U.S. federal government contract or opportunity. </p>
<ul>
<li><p>Parameters</p>
<ul>
<li>_id (required, string, <code>5375057a6c5cc8435b8b4567</code>) … String <code>id</code> of the desired project entity to return.</li>
</ul>
</li>
<li><p>Model</p>
<ul>
...
<h3 id="retrieve-a-single-project-get-">Retrieve a Single Project [GET]</h3>
<ul>
<li><p>Request Project</p>
<ul>
<li><p>Headers</p>
<pre><code>  <span class="hljs-attribute">Accept</span>: <span class="hljs-string">application/json</span>
  <span class="hljs-attribute">X-GT-API-Key</span>: <span class="hljs-string">yourAPIKey</span>
...
<h2 id="search-projects-project-search-q-">Search Projects [/project/search/{?q}]</h2>
<p>Search Projects by keyword or phrase. GovTribe searches project names and synopses.</p>
<ul>
<li><p>Parameters</p>
<ul>
<li>q (required, string <code>Green Laser</code>) … The string with which we will query the projects</li>
</ul>
</li>
</ul>
<ul>
...
<h3 id="retrieve-project-search-results-get-">Retrieve Project Search Results [GET]</h3>
<p>Search all projects by keyword</p>
<ul>
<li><p>Request Search Projects</p>
<ul>
<li><p>Headers</p>
<pre><code>  <span class="hljs-attribute">Accept</span>: <span class="hljs-string">application/json</span>
  <span class="hljs-attribute">X-GT-API-Key</span>: <span class="hljs-string">yourAPIKey</span>
...
<h2 id="filtered-projects-project-setasidetype-workflowstatus-agency-office-person-vendor-category-">Filtered Projects [/project/{?setAsideType,workflowStatus,agency,office,person,vendor,category}]</h2>
<p>Returns a paginated list of filtered projects, ordered by their timestamp property. Multiple filters will use an AND operator. For example, if setAsideType is set to <code>HUBZone</code> and agency is set to <code>51548151db40a5165c0000cf</code>, the returned results will be projects that are both HUBZone set aside and from the U.S. Army.</p>
<h3 id="retrieve-projects-with-specific-attributes-get-">Retrieve Projects with Specific Attributes [GET]</h3>
<ul>
<li><p>Parameters</p>
<ul>
<li><p>setAsideType (optional, string <code>HUBZone</code>) … The set aside type for the Project</p>
<ul>
<li>Values<ul>
<li><code>Total Small Business</code></li>
<li><code>Service-Disabled Veteran-Owned Small Business</code></li>
<li><code>HUBZone</code></li>
<li><code>Competitive 8(a)</code></li>
<li><code>Woman Owned Small Business</code></li>
<li><code>Partial Small Business</code></li>
<li><code>Economically Disadvantaged Woman Owned Small Business</code></li>
<li><code>Emerging Small Business</code></li>
<li><code>Total HBCU / MI</code></li>
<li><code>Partial HBCU / MI</code></li>
</ul>
</li>
</ul>
</li>
<li><p>workflowStatus (optional, string) … The workflow status for the Project</p>
<ul>
<li>Values<ul>
<li><code>Forecasted</code></li>
<li><code>Presolicitation</code></li>
<li><code>Open For Bid</code></li>
...
<li><p>agency = <code>` (optional, string,</code>51548151db40a5165c0000cf`) … The _id for a specific Agency </p>
</li>
<li>office = `` (optional, string) … The _id for a specific Office</li>
<li>person = `` (optional, string) … The _id for a specific Person</li>
<li>vendor = `` (optional, string) … The _id for a specific vendor</li>
<li>category = `` (optional, string) … The _id for a specific category</li>
</ul>
</li>
</ul>
<ul>
...
<h1 id="group-agency">Group Agency</h1>
<h2 id="agency-agency-_id-">Agency [/agency/{_id}]</h2>
<p>An agency is a U.S. government agency. Ain’t that descriptive?  </p>
<ul>
<li><p>Parameters</p>
<ul>
<li>_id (required, string, <code>51548151db40a5165c0000cf</code>) … String <code>id</code> of the desired agency entity.</li>
</ul>
</li>
<li><p>Model</p>
<ul>
...
<h3 id="retrieve-a-single-agency-get-">Retrieve a Single Agency [GET]</h3>
<ul>
<li><p>Request Agency</p>
<ul>
<li><p>Headers</p>
<pre><code>  <span class="hljs-attribute">Accept</span>: <span class="hljs-string">application/json</span>
  <span class="hljs-attribute">X-GT-API-Key</span>: <span class="hljs-string">yourAPIKey</span>
...
<h2 id="agency-slices-agency-_id-slice-">Agency Slices [/agency/{_id}/{slice}]</h2>
<p>Returns a listing (slice) of NTIs that are related to an agency based on the slice name. For example, the <code>vendorsThatWinTotalSmallBusinessSetAsideProjects</code> slice will return a list of vendor NTIs for a given agency that have won projects designated as a Total Small Business set aside.</p>
<ul>
<li><p>Parameters</p>
<ul>
<li>_id (required, string, <code>51548151db40a5165c0000cf</code>) … id of the desired Agency Entity</li>
<li><p>slice (required, string, <code>vendorsThatWinTotalSmallBusinessSetAsideProjects</code>) … A list of entities or slice, relative to the agency. </p>
<ul>
<li>Values<ul>
<li><code>vendorsThatWinTotalSmallBusinessSetAsideProjects</code></li>
<li><code>vendorsThatWinServiceDisabledVeteranOwnedSmallBusinessSetAsideProjects</code></li>
<li><code>vendorsThatWinHUBZoneSetAsideProjects</code></li>
<li><code>vendorsThatWinCompetitive8ASetAsideProjects</code></li>
<li><code>vendorsThatWinWomanOwnedSmallBusinessSetAsideProjects</code></li>
<li><code>vendorsThatWinPartialSmallBusinessSetAsideProjects</code></li>
<li><code>vendorsThatWinEconomicallyDisadvantagedWomanOwnedSmallBusinessSetAsideProjects</code></li>
<li><code>vendorsThatWinEmergingSmallBusinessSetAsideProjects</code></li>
<li><code>vendorsThatWinTotalHBCUMISetAsideProjects</code></li>
<li><code>vendorsThatWinPartialHBCUMISetAsideProjects</code></li>
<li><code>officesThatPostTotalSmallBusinessSetAsideProjects</code></li>
<li><code>officesThatPostServiceDisabledVeteranOwnedSmallBusinessSetAsideProjects</code></li>
<li><code>officesThatPostHUBZoneSetAsideProjects</code></li>
<li><code>officesThatPostCompetitive8ASetAsideProjects</code></li>
<li><code>officesThatPostWomanOwnedSmallBusinessSetAsideProjects</code></li>
<li><code>officesThatPostPartialSmallBusinessSetAsideProjects</code></li>
<li><code>officesThatPostEconomicallyDisadvantagedWomanOwnedSmallBusinessSetAsideProjects</code></li>
<li><code>officesThatPostEmergingSmallBusinessSetAsideProjects</code></li>
<li><code>officesThatPostTotalHBCUMISetAsideProjects</code></li>
<li><code>officesThatPostPartialHBCUMISetAsideProjects</code></li>
<li><code>peopleThatPostTotalSmallBusinessSetAsideProjects</code></li>
<li><code>peopleThatPostServiceDisabledVeteranOwnedSmallBusinessSetAsideProjects</code></li>
<li><code>peopleThatPostHUBZoneSetAsideProjects</code></li>
<li><code>peopleThatPostCompetitive8ASetAsideProjects</code></li>
<li><code>peopleThatPostWomanOwnedSmallBusinessSetAsideProjects</code></li>
<li><code>peopleThatPostPartialSmallBusinessSetAsideProjects</code></li>
<li><code>peopleThatPostEconomicallyDisadvantagedWomanOwnedSmallBusinessSetAsideProjects</code></li>
<li><code>peopleThatPostEmergingSmallBusinessSetAsideProjects</code></li>
<li><code>peopleThatPostTotalHBCUMISetAsideProjects</code></li>
<li><code>peopleThatPostPartialHBCUMISetAsideProjects</code></li>
<li><code>categoriesThatContainTotalSmallBusinessSetAsideProjects</code></li>
<li><code>categoriesThatContainServiceDisabledVeteranOwnedSmallBusinessSetAsideProjects</code></li>
<li><code>categoriesThatContainHUBZoneSetAsideProjects</code></li>
<li><code>categoriesThatContainCompetitive8ASetAsideProjects</code></li>
<li><code>categoriesThatContainWomanOwnedSmallBusinessSetAsideProjects</code></li>
<li><code>categoriesThatContainPartialSmallBusinessSetAsideProjects</code></li>
<li><code>categoriesThatContainEconomicallyDisadvantagedWomanOwnedSmallBusinessSetAsideProjects</code></li>
<li><code>categoriesThatContainEmergingSmallBusinessSetAsideProjects</code></li>
<li><code>categoriesThatContainTotalHBCUMISetAsideProjects</code></li>
<li><code>categoriesThatContainPartialHBCUMISetAsideProjects</code></li>
</ul>
</li>
</ul>
</li>
...
<h3 id="retrieve-a-slice-for-an-agency-get-">Retrieve a Slice for an Agency [GET]</h3>
<ul>
<li><p>Request Slice</p>
<ul>
<li><p>Headers</p>
<pre><code>  <span class="hljs-attribute">Accept</span>: <span class="hljs-string">application/json</span>
  <span class="hljs-attribute">X-GT-API-Key</span>: <span class="hljs-string">yourAPIKey</span>
...
<h2 id="search-agencies-agency-search-q-">Search Agencies [/agency/search/{?q}]</h2>
<p>Find Agencies by their name or acronym</p>
<ul>
<li><p>Parameters</p>
<ul>
<li>q (required, string <code>Defense</code>) … The string with which we will query the agencies</li>
</ul>
</li>
</ul>
<ul>
...
<h3 id="retrieve-agency-search-results-get-">Retrieve Agency Search Results [GET]</h3>
<p>Search all agencies by keyword</p>
<ul>
<li><p>Request Search Projects</p>
<ul>
<li><p>Headers</p>
...
<h1 id="group-office">Group Office</h1>
<h2 id="office-office-_id-">Office [/office/{_id}]</h2>
<p>An Office is a sub unit of a U.S. government agency </p>
<ul>
<li><p>Parameters</p>
<ul>
<li>_id (required, string, <code>51c1d4dadb40a5298c79c731</code>) … String <code>id</code> of the desired Office entity.</li>
</ul>
</li>
<li><p>Model</p>
<ul>
...
<h3 id="retrieve-a-single-office-get-">Retrieve a Single Office [GET]</h3>
<ul>
<li><p>Request Agency</p>
<ul>
<li><p>Headers</p>
...
<h2 id="office-slices-office-_id-slice-slicename-">Office Slices [/office/{_id}/slice/{sliceName}]</h2>
<p>Returns a listing (slice) of NTIs that are related to an office based on the slice name. For example, the <code>vendorsThatWinTotalSmallBusinessSetAsideProjects</code> slice will return a list of vendor NTIs for a given agency that have won projects designated as a Total Small Business set aside.</p>
<ul>
<li><p>Parameters</p>
<ul>
<li>_id (required, string, <code>51c1d4dadb40a5298c79c731</code>) … id of the desired Office Entity</li>
<li><p>sliceName (required, string, <code>vendorsThatWinTotalSmallBusinessSetAsideProjects</code>) … A list of entities or slice, relative to the office. </p>
<ul>
<li>Values<ul>
<li><code>vendorsThatWinTotalSmallBusinessSetAsideProjects</code></li>
<li><code>vendorsThatWinServiceDisabledVeteranOwnedSmallBusinessSetAsideProjects</code></li>
...
<h3 id="retrieve-a-slice-for-an-office-get-">Retrieve a Slice for an Office [GET]</h3>
<ul>
<li><p>Request Slice</p>
<ul>
<li><p>Headers</p>
...
<h2 id="search-offices-office-search-q-">Search Offices [/office/search/{?q}]</h2>
<p>Find an office by its name or acronym.</p>
<ul>
<li><p>Parameters</p>
<ul>
<li>q (required, string <code>Prisons</code>) … The string with which we will query the offices</li>
</ul>
</li>
</ul>
<ul>
...
<h3 id="retrieve-office-search-results-get-">Retrieve Office Search Results [GET]</h3>
<p>Search all agencies by keyword</p>
<ul>
<li><p>Request Search Projects</p>
<ul>
...
<h1 id="group-person">Group Person</h1>
<h2 id="person-person-_id-">Person [/person/{_id}]</h2>
<p>An Person is a U.S. government point of contact for one or more projects </p>
<ul>
<li><p>Parameters</p>
<ul>
<li>_id (required, string, <code>51c275c6ca985fa61e000099</code>) … String <code>id</code> of the desired Person entity.</li>
</ul>
</li>
<li><p>Model</p>
<ul>
...
<h3 id="retrieve-a-single-person-get-">Retrieve a Single Person [GET]</h3>
<ul>
<li><p>Request Person</p>
<ul>
<li><p>Headers</p>
<pre><code>  <span class="hljs-attribute">Accept</span>: <span class="hljs-string">application/json</span>
  <span class="hljs-attribute">X-GT-API-Key</span>: <span class="hljs-string">yourAPIKey</span>
...
<h2 id="person-slices-person-_id-slice-slicename-">Person Slices [/person/{_id}/slice/{sliceName}]</h2>
<p>Returns a listing (slice) of NTIs that are related to an person based on the slice name. For example, the <code>vendorsThatWinTotalSmallBusinessSetAsideProjects</code> slice will return a list of vendor NTIs for a given person that have won projects designated as a Total Small Business set aside.</p>
<ul>
<li><p>Parameters</p>
<ul>
<li>_id (required, string, <code>51f79dd2ca985f9b7c00031c</code>) … id of the desired Office Entity</li>
<li><p>sliceName (required, string, <code>vendorsThatWinTotalSmallBusinessSetAsideProjects</code>) … A list of entities or slice, relative to the office. </p>
<ul>
<li>Values<ul>
<li><code>vendorsThatWinTotalSmallBusinessSetAsideProjects</code></li>
...
<h3 id="retrieve-a-slice-for-a-person-get-">Retrieve a Slice for a Person [GET]</h3>
<ul>
<li><p>Request Slice</p>
<ul>
<li><p>Headers</p>
...
<h2 id="search-people-person-search-q-">Search People [/person/search/{?q}]</h2>
<p>Find a person by their name, email, telephone number, or position.</p>
<ul>
<li><p>Parameters</p>
<ul>
<li>q (required, string <code>Nash</code>) … The string with which we will query the people</li>
</ul>
</li>
<li><p>Model</p>
<ul>
...
<h3 id="retrieve-person-search-results-get-">Retrieve Person Search Results [GET]</h3>
<ul>
<li><p>Request Search Projects</p>
<ul>
<li><p>Headers</p>
...
<h1 id="group-vendor">Group Vendor</h1>
<h2 id="vendor-vendor-_id-">Vendor [/vendor/{_id}]</h2>
<p>An Vendor is an entity that has been awarded a Project </p>
<ul>
<li><p>Parameters</p>
<ul>
<li>_id (required, string, <code>51ed43bdca985f6c78000018</code>) … String <code>id</code> of the desired Vendor entity.</li>
</ul>
</li>
<li><p>Model</p>
<ul>
...
<h3 id="retrieve-a-single-vendor-get-">Retrieve a Single Vendor [GET]</h3>
<ul>
<li><p>Request Vendor</p>
<ul>
<li><p>Headers</p>
<pre><code>  <span class="hljs-attribute">Accept</span>: <span class="hljs-string">application/json</span>
  <span class="hljs-attribute">X-GT-API-Key</span>: <span class="hljs-string">yourAPIKey</span>
...
<h2 id="search-vendors-vendor-search-q-">Search Vendors [/vendor/search/{?q}]</h2>
<p>Find a vendor by name.</p>
<ul>
<li><p>Parameters</p>
<ul>
<li>q (required, string <code>Deloitte</code>) … The string with which we will query the vendors</li>
</ul>
</li>
</ul>
<ul>
...
<h3 id="retrieve-vendor-search-results-get-">Retrieve Vendor Search Results [GET]</h3>
<ul>
<li><p>Request Search Vendors</p>
<ul>
<li><p>Headers</p>
<pre><code>  <span class="hljs-attribute">Accept</span>: <span class="hljs-string">application/json</span>
  <span class="hljs-attribute">X-GT-API-Key</span>: <span class="hljs-string">yourAPIKey</span>
...
<h2 id="vendor-slices-vendor-_id-slice-slicename-">Vendor Slices [/vendor/{_id}/slice/{sliceName}]</h2>
<p>Returns a listing (slice) of NTIs that are related to a vendor based on the slice name. For example, the <code>agenciesThatAwardToThisVendor</code> slice will return a list of agency NTIs that have awarded projects to this vendor.</p>
<ul>
<li><p>Parameters</p>
<ul>
<li>_id (required, string, <code>51ed43bdca985f6c78000018</code>) … id of the desired vendor entity</li>
<li><p>sliceName (required, string, <code>agenciesThatAwardToThisVendor</code>) … A list of entities or slice, relative to the vendor. </p>
<ul>
<li>Values<ul>
<li><code>agenciesThatAwardToThisVendor</code></li>
<li><code>officesThatAwardToThisVendor</code></li>
<li><code>peopleThatAwardToThisVendor</code></li>
<li><code>categoriesThatContainAwardsToThisVendor</code></li>
</ul>
</li>
</ul>
</li>
...
<h3 id="retrieve-a-slice-for-a-vendor-get-">Retrieve a Slice for a Vendor [GET]</h3>
<ul>
<li><p>Request Slice</p>
<ul>
<li><p>Headers</p>
...
<h1 id="group-category">Group Category</h1>
<h2 id="category-category-_id-">Category [/category/{_id}]</h2>
<p>Categories are a hierarchical topical grouping construct. They are based on NAICS codes and PSC codes.  </p>
<ul>
<li><p>Parameters</p>
<ul>
<li>_id (required, string, <code>518ecbf0db40a51b0b000067</code>) … String <code>id</code> of the desired Category entity.</li>
</ul>
</li>
<li><p>Model</p>
<ul>
...
<h3 id="retrieve-a-single-category-get-">Retrieve a Single Category [GET]</h3>
<ul>
<li><p>Request Category</p>
<ul>
<li><p>Headers</p>
<pre><code>  <span class="hljs-attribute">Accept</span>: <span class="hljs-string">application/json</span>
  <span class="hljs-attribute">X-GT-API-Key</span>: <span class="hljs-string">yourAPIKey</span>
...
<h2 id="search-categories-category-search-q-">Search Categories [/category/search/{?q}]</h2>
<p>Find a category by its name.</p>
<ul>
<li><p>Parameters</p>
<ul>
<li>q (required, string <code>Mining</code>) … The string with which we will query the categories</li>
</ul>
</li>
</ul>
<ul>
...
<h2 id="category-slices-category-_id-slice-slicename-">Category Slices [/category/{_id}/slice/sliceName]</h2>
<p>Returns a listing (slice) of NTIs that are related to a category based on the slice name. For example, the <code>agenciesThatAwardProjectsInThisCategory</code> slice will return a list of agency NTIs that award projects within this category.</p>
<ul>
<li><p>Parameters</p>
<ul>
<li>_id (required, string, <code>518ecbf0db40a51b0b000029</code>) … id of the desired category</li>
<li><p>sliceName (required, string, <code>agenciesThatAwardProjectsInThisCategory</code>) … A list of entities or slice, relative to the category. </p>
<ul>
<li>Values<ul>
<li><code>agenciesThatAwardProjectsInThisCategory</code></li>
<li><code>officesThatAwardProjectsInThisCategory</code></li>
<li><code>peopleThatAwardProjectsInThisCategory</code></li>
<li><code>vendorsThatWinProjectsInThisCategory</code></li>
</ul>
</li>
</ul>
</li>
...
<h3 id="retrieve-a-slice-for-a-category-get-">Retrieve a Slice for a Category [GET]</h3>
<ul>
<li><p>Request Slice</p>
<ul>
<li><p>Headers</p>
...
<h1 id="group-activity">Group Activity</h1>
<h2 id="activity-activity-_id-">Activity [/activity/{_id}]</h2>
<p>The Activity collection provides objects representing the ongoing activity of one or more of the other entity types. It is a time series of the world of government procurement.</p>
...
<li><p>Parameters</p>
<ul>
<li>_id (required, string, <code>51f79dd2ca985f9b7c00031c</code>) … string <code>id</code> of the desired Activity.</li>
</ul>
</li>
<li><p>Model</p>
<ul>
...
<h3 id="retrieve-a-single-activity-get-">Retrieve a Single Activity [GET]</h3>
<ul>
<li><p>Request Activity</p>
<ul>
<li><p>Headers</p>
<pre><code>  <span class="hljs-attribute">Accept</span>: <span class="hljs-string">application/json</span>
  <span class="hljs-attribute">X-GT-API-Key</span>: <span class="hljs-string">yourAPIKey</span>
...
<h2 id="activity-feed-activity-feed-ids-since-">Activity Feed [/activity/feed/{ids,since}]</h2>
<p>Retrieving multiple activity objects for one or more entities produces an activity feed. This is accomplished by submitting an array of <code>_id</code> properties to the <code>feed</code> endpoint along with a optional since timestamp value. </p>
...
<li><p>Parameters</p>
<ul>
<li>ids (string, <code>51548151db40a5165c0000d1,51c1d4dddb40a5298c79c740</code>) … one or more comma separated <code>id</code> strings for the desired entities.</li>
<li>since  (optional, number, <code>1399822866</code>) … the distance back in time for a particular call as milliseconds. Default is one year </li>
</ul>
</li>
<li><p>Model</p>
<ul>
...
<h3 id="retrieve-an-activity-feed-get-">Retrieve an Activity Feed [GET]</h3>
<ul>
<li><p>Request Activity</p>
<ul>
<li><p>Headers</p>
...
<li><p>Parameters</p>
<ul>
<li>_id (required, string, <code>5359397fdb40a5238000621e</code>) … String <code>id</code> of the desired protest entity.</li>
</ul>
</li>
<li><p>Model</p>
<ul>
...
<h3 id="retrieve-a-single-protest-get-">Retrieve a Single Protest [GET]</h3>
<ul>
<li><p>Request Vendor</p>
<ul>
<li><p>Headers</p>
...
<h2 id="search-protests-protest-search-q-">Search Protests [/protest/search/{?q}]</h2>
<p>Find a protest by…</p>
<ul>
<li><p>Parameters</p>
<ul>
<li>q (required, string <code>Challenge</code>) … The string with which we will query the protests</li>
</ul>
</li>
<li><p>Model</p>
<ul>
...
<h3 id="retrieve-protest-search-results-get-">Retrieve Protest Search Results [GET]</h3>
<ul>
<li><p>Request Search Protests</p>
<ul>
<li><p>Headers</p>
<pre><code>  <span class="hljs-attribute">Accept</span>: <span class="hljs-string">application/json</span>
  <span class="hljs-attribute">X-GT-API-Key</span>: <span class="hljs-string">yourAPIKey</span>
