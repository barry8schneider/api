...
</dd></dl></li></ul><ul class="list-group"><li class="list-group-item"><strong>Request&nbsp;&nbsp;<code>Agency</code></strong><a data-toggle="collapse" data-target="#4fcca7cd1dbeaf0abdcf02e15a86918c" class="pull-right">Toggle</a></li><li id="4fcca7cd1dbeaf0abdcf02e15a86918c" class="list-group-item panel-collapse collapse"><div class="description"></div><h5>Headers</h5><pre><code><span class="hljs-attribute">Accept</span>: <span class="hljs-string">application/json</span><br><span class="hljs-attribute">X-GT-API-Key</span>: <span class="hljs-string">yourAPIKey</span><br></code></pre></li><li class="list-group-item"><strong>Response&nbsp;&nbsp;<code>200</code></strong><a data-toggle="collapse" data-target="#90576c898faa5a34cd131d132677c351" class="pull-right">Toggle</a></li><li id="90576c898faa5a34cd131d132677c351" class="list-group-item panel-collapse collapse"><h5>Body</h5><pre><code>{
    acronyms: <span class="hljs-string">"None Listed"</span>,
    agencies: [
        {
...
</dd></dl></li></ul><ul class="list-group"><li class="list-group-item"><strong>Request&nbsp;&nbsp;<code>Search Vendors</code></strong><a data-toggle="collapse" data-target="#35d3519ee3111087c3deb983a508a8ac" class="pull-right">Toggle</a></li><li id="35d3519ee3111087c3deb983a508a8ac" class="list-group-item panel-collapse collapse"><div class="description"></div><h5>Headers</h5><pre><code><span class="hljs-attribute">Accept</span>: <span class="hljs-string">application/json</span><br><span class="hljs-attribute">X-GT-API-Key</span>: <span class="hljs-string">yourAPIKey</span><br></code></pre></li><li class="list-group-item"><strong>Response&nbsp;&nbsp;<code>200</code></strong><a data-toggle="collapse" data-target="#42c35560fbc51b6897c250fe7cf859ac" class="pull-right">Toggle</a></li><li id="42c35560fbc51b6897c250fe7cf859ac" class="list-group-item panel-collapse collapse"><h5>Body</h5><pre><code><span class="hljs-rules">{
    <span class="hljs-rule"><span class="hljs-attribute">results</span>:<span class="hljs-value"> [
        {
